products = [
    ...
    {
      '_id': '7',
      'name': 'Apple Watch Series 3 with Silver Case',
      'image': '/images/apple_watch.jpg',
      'description':
        'The All New Apple Watch Series 3 - with silver aluminum case with white sports band fits comfortably and with all new functions supporting all apple devices.',
      'brand': 'Apple',
      'category': 'Electronics',
      'price': 229.99,
      'countInStock': 0,
    ...
    {
      '_id': '8',
      'name': 'Samsung s22 Ultra Ghost White Edition',
