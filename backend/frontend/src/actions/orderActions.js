...
import { 
    ...
    ORDER_OBTAIN_REQUEST,
    ORDER_OBTAIN_SUCCESS,
    ORDER_OBTAIN_FAIL,
...
export const obtainOrders = () => async (dispatch, getState) =>{
    try{
        dispatch({
            type: ORDER_OBTAIN_REQUEST
        })
        ...
        dispatch({
            type: ORDER_OBTAIN_SUCCESS,
            payload: data
        })

    }catch(error){
        dispatch({ 
            type: ORDER_OBTAIN_FAIL, 
            payload: error.response && error.response.data.detail
                ? error.response.data.detail
                : error.message,
        })
