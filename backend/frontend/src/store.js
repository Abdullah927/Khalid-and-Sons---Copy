...
import { orderCreateReducer, orderDetailsReducer, orderPayReducer, orderListReducer, orderObtainReducer, orderDeliverReducer } from './reducers/orderReducers'
...
const reducer = combineReducers({
    ...
    orderObtain: orderObtainReducer,
